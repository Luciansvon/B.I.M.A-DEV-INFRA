...
The production request still has no held-out queries while the reviewed record corpus is `5/100`. The benchmark therefore returns `BLOCKED` and creates no SQLite database.
