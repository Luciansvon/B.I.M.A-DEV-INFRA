...
- [ ] Complete the additive v2 migration: adapter, deterministic single-check aggregation and an additive shared consumer action exist; hosted action evidence, consumer PASS/FAIL, opt-in and rollback evidence remain pending. v1 is unchanged.
