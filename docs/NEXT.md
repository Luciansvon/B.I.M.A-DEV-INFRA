...
1. Complete the bounded pinact increment from Issue #3 with local and hosted evidence.
2. Continue Issue #3 P0 sequentially with zizmor, then canonical evidence and the agent packet. Add one bounded tool increment at a time with measured value.
