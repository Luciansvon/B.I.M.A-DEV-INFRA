...
- Verify downloaded CI tools against a fixed SHA-256 digest before execution. The current `actionlint`, prek, and action-validator release binaries are versioned and digest-checked.
